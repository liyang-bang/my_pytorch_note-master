...
def main():
    train_path = 'E:/CennaviData/picture/train_144-256'
    val_path = 'E:/CennaviData/picture/val_144-256'
    ...
    # 超参数可自行指定
    model = train(train_dataset, val_dataset, batch_size=1, epochs=1, learning_rate=0.1, wt_decay=0)
    # 保存模型
    torch.save(model, 'E:/CennaviData/picture/amap_traffic_GaoDe/cnn_model/model_net2.pkl')
