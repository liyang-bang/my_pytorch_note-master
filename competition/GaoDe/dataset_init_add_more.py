...
def generate_label_dic(path):
    ...
    for dict in data:
        ...
        for frame in frames:
            ...
            key_label_set.add(id + '_' + frame_name + ',' + str(status))
...
def main():
    ...
    list1, list2 = split_list(list(label_set), 5600)
    filename_train = "D:\\Dataset\\amap_traffic_GaoDe\\train_144-256_more_5600\\label.csv"
    list_to_file(list1,filename_train)
    filename_val = "D:\\Dataset\\amap_traffic_GaoDe\\val_144-256_more_1292\\label.csv"
    list_to_file(list2, filename_val)

    origin_pics = "D:\\Dataset\\amap_traffic_GaoDe\\0712_train_144-256"
    out_train = 'D:\\Dataset\\amap_traffic_GaoDe\\train_144-256_more_5600\\pics'
    out_val = 'D:\\Dataset\\amap_traffic_GaoDe\\val_144-256_more_1292\\pics'
